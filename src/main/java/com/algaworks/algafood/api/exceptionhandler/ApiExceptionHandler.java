...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ProblemType promType = ProblemType.PARAMETRO_INVALIDO;
		String detail = "Um ou mais campos estão inválidos. Faça o preenchimento correto e tente novamenteo";
		Problem problem = createProblemBuilder(status, promType, detail).userMessage(detail).build();
		
		return handleExceptionInternal(ex, problem, headers, status, request);
	}
	
	@ExceptionHandler(Exception.class)
	public ResponseEntity<?> handlehandleUncaught(
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex,
		...
		String detail = String.format("O recurso '%s' que você tentou acessar, é inexistente", resourceName);
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(detail)
				.build();
		return handleExceptionInternal(ex, problem, headers, status, request);
